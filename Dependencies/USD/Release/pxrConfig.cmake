...
if(OFF)
    ...
    if (NOT DEFINED Python3_VERSION)
        find_dependency(Python3 "." EXACT COMPONENTS Development)
    else()
...
if (PXR_FIND_TBB_IN_CONFIG)
    ...
    _add_property(INTERFACE_INCLUDE_DIRECTORIES "D:/Stuff/Projects/USD_Release/include")
    _add_property(INTERFACE_COMPILE_DEFINITIONS "$<$<OR:$<CONFIG:Debug>,$<CONFIG:RelWithDebInfo>>:TBB_USE_DEBUG=1>")
    _add_property(INTERFACE_LINK_DIRECTORIES "$<$<CONFIG:Debug>:D:/Stuff/Projects/USD_Release/lib>;$<$<CONFIG:Release>:D:/Stuff/Projects/USD_Release/lib>")
    _add_property(IMPORTED_IMPLIB "D:/Stuff/Projects/USD_Release/lib/tbb.lib")
    _add_property(IMPORTED_LOCATION "D:/Stuff/Projects/USD_Release/bin/tbb.dll")
endif()

if (NOT DEFINED PXR_FIND_OPENSUBDIV_IN_CONFIG)
    set(PXR_FIND_OPENSUBDIV_IN_CONFIG "")
endif()
if (PXR_FIND_OPENSUBDIV_IN_CONFIG)
    find_dependency(OpenSubdiv  CONFIG)
endif()
...
if(ON)
    if (NOT DEFINED MaterialX_DIR)
        if (NOT [[D:/Stuff/Projects/USD_Release/lib/cmake/MaterialX]] STREQUAL "")
            set(MaterialX_DIR [[D:/Stuff/Projects/USD_Release/lib/cmake/MaterialX]])
        endif()
    endif()
